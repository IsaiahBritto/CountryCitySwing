...
export default function RegistrationPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto mt-10 px-4">
      <h1 className="text-3xl font-bold text-primary mb-6">Event Registration</h1>
          ...
          {signups.length === 0 ? (
            ...
            <div className="space-y-3">
              {signups.map((signup) => (
                <div
                  key={signup.id}
                  className={`p-4 rounded-lg border-2 ${getRowColor(signup)}`}
                >
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-4">
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input
                          ...
                          className="w-5 h-5 text-primary focus:ring-primary border-neutral-600 bg-neutral-700 rounded"
                        />
