...
export function buildNewsletterHtml(
  ...
  for (const e of weekEvents) {
    ...
    const signupHref = e.signup_link ? escapeHtml(e.signup_link) : siteUrl + "/#upcoming-events";
    const signupPart =
  ...
  let workshopSection = "";
  if (workshop) {
    const workshopSignupHref = workshop.signup_link ? escapeHtml(workshop.signup_link) : siteUrl + "/#upcoming-events";
...
export function buildNewsletterText(
  ...
  if (workshop) {
    ...
    lines.push((workshop.signup_link || siteUrl + "/#upcoming-events") + "\n");
  }
